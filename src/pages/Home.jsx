...
const Home = () => {
  ...
  return (
    <div className="space-y-16 pb-16">
      {/* Hero Section with Flying Airplane Motion */}
      <section className="relative rounded-3xl overflow-hidden h-[500px] sm:h-[600px] flex items-center justify-center shadow-2xl">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-slate-950/85 via-blue-950/70 to-slate-900/60"></div>
        </div>

        {/* Continuous Flying Airplane Motion Effect */}
        <PlaneAnimation overlay={true} />
        
        <div className="relative z-20 text-center px-4 w-full max-w-4xl mx-auto mt-[-30px]">
          <span className="inline-block py-1.5 px-4 rounded-full bg-blue-500/20 text-blue-300 backdrop-blur-md mb-6 text-xs font-extrabold tracking-widest uppercase animate-fade-in border border-blue-400/30">
            ✈️ EXPLORE THE WORLD WITH CAPPSRA
          </span>
          ...
          <p className="text-xl text-slate-100/90 mb-10 max-w-2xl mx-auto drop-shadow-md font-medium leading-relaxed">
            Book flights to over 100+ locations worldwide. Exclusive deals, premium seating, and 3 free welcome discount coupons await.
          </p>

          {/* Search Bar */}
          <div className="bg-white/95 dark:bg-dark-card/95 p-3 rounded-3xl shadow-2xl max-w-3xl mx-auto backdrop-blur-xl border border-white/20">
            <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-2">
              <div className="flex-1 relative flex items-center bg-slate-100 dark:bg-[#0f172a] rounded-2xl overflow-hidden">
              ...
              <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl transition-all active:scale-95 sm:w-auto w-full uppercase tracking-wider text-sm shadow-lg shadow-blue-600/30">
                Search
              </button>
            </form>
          </div>
